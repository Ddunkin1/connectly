    ...
    return (
        <>
            ...
            <div className="fixed bottom-4 right-4 z-50">
                {!isCollapsed ? (
                    <div className="bg-[#252538] rounded-xl shadow-xl border border-gray-700 w-80 flex flex-col">
                        {/* Header */}
                                ...
                                recentConversations.map((conversation) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className="w-full flex items-center space-x-3 p-3 hover:bg-white/5 border-b border-gray-700/50 transition-colors"
                                        >
                                            <div className="relative">
                                                <Avatar
                    ...
                    <button
                        ...
                        className="bg-[#252538] rounded-xl shadow-xl border border-gray-700 px-4 py-2 flex items-center space-x-2 hover:bg-[#2D2D44] transition-colors"
                    >
                        <div className="relative">
                            <Avatar src={user?.profile_picture} alt={user?.name} size="sm" />
                            <span className="absolute bottom-0 right-0 w-3 h-3 bg-green-500 border-2 border-[#252538] rounded-full"></span>
