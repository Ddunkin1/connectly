...
const MessageUserPanel = ({ otherUser, mediaItems = [], onViewAllMedia }) => {
    ...
    return (
        <section className="w-72 shrink-0 border-l border-[var(--theme-border)] flex flex-col bg-[var(--theme-bg-main)] overflow-y-auto custom-scrollbar">
            <div className="p-8 flex flex-col items-center text-center">
                <div className="relative mb-4">
                    <img src={otherUser.profile_picture} alt={otherUser.name} className="w-24 h-24 rounded-full object-cover ring-4 ring-[var(--theme-surface-hover)]" />
                    <div className="absolute bottom-1 right-1 w-5 h-5 bg-green-500 border-4 border-[var(--theme-bg-main)] rounded-full" />
                </div>
                ...
                <div className="flex gap-4 mb-8">
                    <button type="button" className="flex flex-col items-center gap-1 group">
                        <div className="w-10 h-10 rounded-full bg-[var(--theme-surface-hover)] flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-all">
                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            ...
                            {mediaItems.length === 0 && (
                                <div className="col-span-3 w-full h-16 bg-[var(--theme-surface-hover)] rounded-lg flex items-center justify-center text-xs font-bold text-slate-400">No media yet</div>
                            )}
                        </div>
                    </div>
                    <div>
                        ...
                        <div className="space-y-2">
                            <button type="button" className="w-full flex items-center justify-between p-3 rounded-xl hover:bg-[var(--theme-surface-hover)] transition-colors text-sm text-white">
                                <span>Pinned Messages</span>
                                <span className="material-symbols-outlined text-slate-400 text-lg">chevron_right</span>
                            </button>
                            <button type="button" className="w-full flex items-center justify-between p-3 rounded-xl hover:bg-[var(--theme-surface-hover)] transition-colors text-red-500">
