        ...
        <div className="mb-6 theme-surface rounded-xl p-6 border border-white/5 shadow-lg">
            ...
            <ul className="space-y-3 text-xs md:text-sm text-slate-300">
                <li className="flex items-start gap-3">
                    <span className={`material-symbols-outlined text-[18px] mt-[1px] shrink-0 ${hasProfileBasics ? 'text-green-500' : 'text-slate-500'}`}>
                        {hasProfileBasics ? 'check_circle' : 'radio_button_unchecked'}
                    </span>
                    <span>
                        <span className="font-medium">Complete your profile</span>{' '}
                        <span className="text-slate-400">Add a photo and bio.</span>{' '}
                ...
                <li className="flex items-start gap-3">
                    <span className={`material-symbols-outlined text-[18px] mt-[1px] shrink-0 ${hasConnections ? 'text-green-500' : 'text-slate-500'}`}>
                ...
                <li className="flex items-start gap-3">
                    <span className={`material-symbols-outlined text-[18px] mt-[1px] shrink-0 ${hasJoinedCommunity ? 'text-green-500' : 'text-slate-500'}`}>
